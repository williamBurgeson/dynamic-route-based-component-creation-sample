// from https://github.com/angular/angular/blob/master/packages/router/src/router.ts
...
export function parentLoadedConfig(snapshot: ActivatedRouteSnapshot): any /*LoadedRouterConfig*/ | null {
